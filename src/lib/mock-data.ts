...
export const guests: Guest[] = [
  {
    ...
    stayHistory: [
      { id: 'stay-1-1', checkInDate: '2023-08-15', checkOutDate: '2023-08-20', roomType: 'Deluxe Suite', notes: 'Celebrated anniversary. Requested late checkout.' },
      { id: 'stay-1-2', checkInDate: '2023-12-22', checkOutDate: '2023-12-26', roomType: 'Standard King', notes: 'Holiday visit.' },
      { id: 'stay-1-3', checkInDate: '2024-03-10', checkOutDate: '2024-03-12', roomType: 'Deluxe Suite', notes: 'Business trip. Used the conference room facilities.' },
    ],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/100x100.png',
    stayHistory: [
      { id: 'stay-2-1', checkInDate: '2024-05-01', checkOutDate: '2024-05-05', roomType: 'Ocean View Balcony', notes: 'First time stay. Enjoyed the spa services.' },
    ],
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/100x100.png',
    stayHistory: [
      { id: 'stay-3-1', checkInDate: '2022-06-20', checkOutDate: '2022-06-25', roomType: 'Penthouse', notes: 'Annual summer vacation.' },
  ...
  },
  {
    ...
    avatarUrl: 'https://placehold.co/100x100.png',
    stayHistory: [
        { id: 'stay-4-1', checkInDate: '2023-09-01', checkOutDate: '2023-09-04', roomType: 'Standard Queen', notes: 'Attended a wedding nearby.' },
        { id: 'stay-4-2', checkInDate: '2024-04-15', checkOutDate: '2024-04-18', roomType: 'Standard Queen', notes: 'Complained about noise from the street. Was moved to a quieter room.' },
    ],
